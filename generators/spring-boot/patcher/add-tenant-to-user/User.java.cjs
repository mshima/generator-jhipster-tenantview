...
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;`,
  },
  {
    ...
    tmpl: context => `@FilterDef(name = "${context.tenant.entityNameUpperCase}_FILTER", parameters = {@ParamDef(name = "${context.tenant.entityNameSpinalCased}Id", type = "long")})
@Filter(name = "${context.tenant.entityNameUpperCase}_FILTER", condition = "${context.tenant.entityNameSpinalCased}_id = :${context.tenant.entityNameSpinalCased}Id")
$1`,
  },
  {
    type: 'replaceContent',
