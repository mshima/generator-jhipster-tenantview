...
const tmpls = [
    ...
    },
    {
        ...
        tmpl: context => `<li *jhiHasAnyAuthority="'ROLE_${context.tenantNameUpperCase}_ADMIN'" ngbDropdown id="${context.tenantNameLowerCase}-admin-menu-container" class="nav-item dropdown pointer" display="dynamic" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}">
                <a class="nav-link dropdown-toggle" ngbDropdownToggle href="javascript:void(0);" id="${context.tenantNameLowerFirst}-admin-menu">
                    <span>
                        ...
                        <span jhiTranslate="global.menu.${context.tenantNameLowerFirst}Admin.main">${context.tenantNameUpperFirst} Administration</span>
                    </span>
                </a>
