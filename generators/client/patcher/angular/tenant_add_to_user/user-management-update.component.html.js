...
$3    <option [ngValue]="${context.tenantNameLowerFirst}Option.id === editForm.get('${context.tenantNameLowerFirst}')!.value?.id ? editForm.get('${context.tenantNameLowerFirst}')!.value : ${context.tenantNameLowerFirst}Option" *ngFor="let ${context.tenantNameLowerFirst}Option of companies trackBy: track${context.tenantNameUpperFirst}ById">{{${context.tenantNameLowerFirst}Option.name}}</option>
$3</select>
$2</div>
$1`;
        }
